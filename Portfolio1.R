...
dic_fixed_model <- data.frame(f_data = test$fixtofix_DIC, ldata = test$fixtolearn_DIC)
dic_learning_model <- data.frame(f_data = test$learntofix_DIC, ldata = test$learntolearn_DIC)
# Find minimum
